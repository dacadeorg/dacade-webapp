...
<template>
  <div>
    ...
    >
      ...
      >
        <div class="notification mt-2">
          ...
          Payout request for {{ payoutRequestsPending[coinName] }}
          {{ coinName }} pending.
        </div>
      </div>
      <div v-else>
        ...
        >
          ...
          the {{ coinName }} address: {{ userWalletAddresses[coinName] }}
    ...
    >
      ...
      <div v-else>
        <div
          v-b-modal="'add-social-media-verification' + coinName"
          class="btn-add btn mt-2 mb-4 small-shadow"
        >
          Add social media verification
        </div>
        <b-modal
          :id="'add-social-media-verification' + coinName"
