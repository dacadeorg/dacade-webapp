  ...
  <section>
    ...
    >
      ...
      <form-user-wallet-address
        ...
        :key="key"
        :test="`New ${key} wallet address:`"
        :method="updateWalletAddress"
        :modal="'add-address-modal2' + key"
        class="btn-edit btn mt-2 mb-2 muted-dark small-shadow"
        :message="'Change {{ key }} Address'"
        ...
        >
          <div>
            <form-update-user-verification
              :on-update-verification="updateUserVerifications"
            />
          </div>
        </b-modal>
      </div>
    ...
    <!-- --------------------if else not UV and UVSM end------------------------- -->
    <!-- --------------------if else not UWA UWAK------------------------- -->
    ...
    >
      <form-user-wallet-address
        ...
        :test="key + ' wallet address:'"
        :on-address-change="updateWalletAddress"
        :modal="'add-address-modal' + key"
        class="btn-add btn mt-2 mb-4 small-shadow"
        :message="'Add {{ key }} Address'"
        :title="`Add ${key} address`"
      />
    </div>
    <!-- wallet address 2 end-->
    <!-- --------------------if else not UWA UWAK------------------------- -->
  </section>
</template>
...
import UserWalletAddress from '@/components/profile/balanceConditions/UserWalletAddress.vue'
