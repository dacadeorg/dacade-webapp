  ...
  <div>
    <div class="nav-wrapper">
      ...
      <ul class="nav flex-column">
        <li class="nav-item">
          <nuxt-link
            :to="{ path: communityPath($route.params.slug, 'introduction') }"
          >
        ...
        <li class="nav-item">
          ...
          <nuxt-link
            :to="{ path: communityPath($route.params.slug, 'submissions') }"
          >
            Submissions
          </nuxt-link>
        </li>
        ...
        <li class="nav-item">
          ...
          <nuxt-link
            :to="{ path: communityPath($route.params.slug, 'scoreboard') }"
          >
            Scoreboard
          </nuxt-link>
        </li>
