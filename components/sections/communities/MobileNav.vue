<template>
  <div>
    <div
      ...
      class="text-sm font-medium -mt-4 -mx-16 relative px-16 pt-4 py-4 md:py-7 border-b-2"
    ...
    >
      <span class="flex">
        ...
        <p class="px-4" @click="state.visiblity = !state.visiblity">Navigate between pages</p>
      </span>
