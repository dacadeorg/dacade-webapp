<template>
  <div v-if="referrals && referrals.length" class="relative flex items-center">
    <div class="flex pr-3">
      <Avatar
        v-for="(referral, index) in previewList" :key="index"
    ...
    <div class=" text-sm md:flex text-gray-500 md:font-medium font-normal relative">
      <span class="md:inline-block">{{referrals.length}} Friends have used your invite code</span>
